...
<div class= "grand_container">
    <div class="grand_image">
        <img src="{{ asset('images/membership-3.png') }}" alt="Join 2">
    </div>
    <h1>Grand Membership</h1>
    <h2><div class="price">$5,950 </div><small style="color:#777"> ($165/month) </small>OVER 3 YEARS </h2>
    <br>
    <ul>
        <li>Encourage up to 10 regional churches to join your local church in one campus.</li>
        <li>Unlimited number of students permitted to attend.</li>
       <li>10% Discount of Training Summits</li>
...
<center>
  ...
  <h3>Create Your Account</h3>
   ...
   <p style="margin-left:-192px;padding:5px; color: #999;">Choose a name for of your Campus that reflects your Community, Town, City or Region.</p>
   <small style="margin-left:-144px; color: #999;" >(For Example: Queens Divinity School, Switzerland Divinity School, Los Angeles Divinity School, Southeast Florida)</small>
   <br>
   <br>
