...
<div class= "growth_container">
    ...
    <h1>GROWTH MEMBERSHIP</h1>
    <h2>SEVEN CREDENTIALS <div class="price">$2950</div> <small>($82/month)</small> <br> OVER 3 YEARS <br> <small>(1 FREE CREDENTIAL)</small></h2>
    <br>
    <ul>
        <li>Equip One Leader</li>
...
<center>
  ...
  <h2>Registration</h2>
  <h3 style="color:#999">Create Your Account</h3>
</div>
  <br>
