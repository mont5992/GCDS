...
<div class= "global_container">
    ...
    <h1>Global Membership</h1>
    <h2><div class="price">$9,950</div><small style="color:#777"> ($267/month) </small>OVER 3 YEARS </h2>
    <br>
    <ul>
        <li>Expand the opportunity for the pastor to select up to 50 local churches anywhere in the world to become a part of his/her campus.</li>
        <li>Unlimited number of students permitted to attend.</li>
       <li>15% Discount of Training Summits</li>
        <li>15% off Global Church Network Resources</li>
